...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String TAG = "drive-app";
        ...
        task.addOnSuccessListener(
                new OnSuccessListener<GoogleSignInAccount>() {
                    ...
                    public void onSuccess(GoogleSignInAccount googleSignInAccount) {
                        ...
                        DriveResourceClient mDriveResourceClient = Drive.getDriveResourceClient(getApplicationContext(), googleSignInAccount);
                        // Start camera.
...
public class MainActivity extends Activity {
    ...
    public void checkStatus (View view){
        ConnectivityManager connMgr = (ConnectivityManager) getSystemService(Context.CONNECTIVITY_SERVICE);
        NetworkInfo networkInfo = connMgr.getActiveNetworkInfo();
        final TextView netStat = findViewById(R.id.netStat);
